"""Collection of functions to get linear point from camb results. This version focuses
on getting the linear point in units of Mpc. However, it follows the convention of camb
when getting the matter power spectrum P(kh). It scales k when interpoling P(k).

Main function is get_lp.
"""
